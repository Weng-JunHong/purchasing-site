<html>
 <head>
  ...
  <title>mizuno_shelves_others</title>
...
<%
  ...
  String sql= "SELECT * FROM mizuno_others";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Mizuno others</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/mizuno/O/"+rs.getObject("p_id")+".jpg></td>");          //圖示
