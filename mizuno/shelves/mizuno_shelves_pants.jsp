<html>
 <head>
  ...
  <title>mizuno_shelves_pants</title>
...
<%
  ...
  String sql= "SELECT * FROM mizuno_pants";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Mizuno pants</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/mizuno/P/"+rs.getObject("p_id")+".jpg></td>");          //圖示
