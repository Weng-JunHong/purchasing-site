<html>
 <head>
  ...
  <title>mizuno_shelves_clothes</title>
...
<%
  ...
  String sql= "SELECT * FROM mizuno_clothes";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Mizuno clothes</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/mizuno/T/"+rs.getObject("p_id")+".jpg></td>");          //圖示
