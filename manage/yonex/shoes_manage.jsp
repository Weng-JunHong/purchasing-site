...
<%
  try{
    ...
    String sql= "SELECT * FROM yonex_shoes";  //讀取資料庫table:products_shoes資料
    ResultSet rs = st.executeQuery(sql);  //不可手動新增

%>

  <center><h1>Yonex shoes manage</h1><table>
    <tr>
	<th>商品編號</th>
	<th>商品名稱</th>
	<th>圖示</th>
...
<%
    while (rs.next() ){
      ...
      out.println("<td align=center>"+"<img src=../../pic/yonex/S/"+rs.getObject("p_id")+".jpg width=100></td>");//圖示
