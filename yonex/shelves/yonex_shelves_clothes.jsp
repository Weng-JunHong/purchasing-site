<html>
 <head>
  ...
  <title>yonex_shelves_clothes</title>
...
<%
  ...
  String sql= "SELECT * FROM yonex_clothes";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Yonex clothes</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/yonex/T/"+rs.getObject("p_id")+".jpg></td>");          //圖示
 ...
 %> 
  ...
  <a href="../yonex_select.jsp" class="submit4"><input type="submit" value="Back" /></a>
 </body>
</html>
