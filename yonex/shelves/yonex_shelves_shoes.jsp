<html>
 <head>
  ...
  <title>yonex_shelves_shoes</title>
...
<%
  ...
  String sql= "SELECT * FROM yonex_shoes";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="../../order.jsp">
  <center><h1>Yonex shoes</h1>
 ...
 <%
    ...
    while (rs.next() ){
      out.println("<tr><td><input type=checkbox name=order_id value="+rs.getObject("p_id")+"</td>");   //商品編號
      out.println("<td>"+rs.getObject("p_name")+"</td>");                                         //商品名稱
      out.println("<td>"+"<img src=../../pic/yonex/S/"+rs.getObject("p_id")+".jpg></td>");          //圖示
      out.println("<td> NT$ "+rs.getObject("price")+"</td></tr>");                                //售價
      
    }
    
    String[] data = request.getParameterValues("order_id");  
 ...
 %> 
    ...
    <input type="reset" value="Reset" class="submit2" /><br/>
