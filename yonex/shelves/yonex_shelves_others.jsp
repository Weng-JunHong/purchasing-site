<html>
 <head>
  ...
  <title>yonex_shelves_others</title>
...
<%
  ...
  String sql= "SELECT * FROM yonex_others";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Yonex others</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/yonex/O/"+rs.getObject("p_id")+".jpg></td>");          //圖示
