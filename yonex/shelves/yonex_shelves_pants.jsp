<html>
 <head>
  ...
  <title>yonex_shelves_pants</title>
...
<%
  ...
  String sql= "SELECT * FROM yonex_pants";
  ResultSet rs = st.executeQuery(sql);
    
%>

 <form action="order.jsp">
  <center><h1>Yonex pants</h1>
 ...
 <%
    ...
    while (rs.next() ){
      ...
      out.println("<td>"+"<img src=../../pic/yonex/P/"+rs.getObject("p_id")+".jpg></td>");          //圖示
